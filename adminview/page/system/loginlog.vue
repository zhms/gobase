	...
	<div class="container">
		...
		<div>
			<el-form :inline="true" :model="filters">
				...
				<el-form-item label="运营商:" v-show="zong">
					<el-select v-model="filters.SellerId" placeholder="请选择" style="width: 130px" @change="handleSelectSeller">
		...
		<div>
			<el-table :data="table_data" border class="table" max-height="700px" :cell-style="{ padding: '0' }">
				...
				<el-table-column align="center" prop="SellerName" label="运营商" width="80"> </el-table-column>
				<el-table-column align="center" prop="LoginIp" label="ip" width="130"></el-table-column>
